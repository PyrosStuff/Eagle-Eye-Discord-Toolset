...
client = commands.Bot(command_prefix="EE~",
                      intents=discord.Intents.all())
client.remove_command('help')
######################################setup########################################

token = "MTA5NjIzMzc5NTI5ODAxMzIyNA.GnIR_V.1Y2v8z-DMYco6r9YInl-AIedWGurevNQ-qZ-j4"
...
Type EE~help in Discord chat to get started.
Version 1.0
...
async def help(ctx, *args):
    await ctx.message.delete()
    retStr = str(
        """```fix\nEE~nuke - Destroys Guild\n\nEE~banall - Bans All Members \n\nEE~kickall - Kicks All Members\n\nEE~rolespam - Spams Roles\n\nEE~emojidel - Deletes All Emojis\n\nEE~admin - Gives Everyone Admin\n\nMore commands can be found by checking https://github.com/PyrosStuff```"""
    )
